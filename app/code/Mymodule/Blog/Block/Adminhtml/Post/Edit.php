<?php
namespace Mymodule\Blog\Block\Adminhtml\Post;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Mymodule_Blog';
        $this->_controller = 'adminhtml_post';

        parent::_construct();

        if ($this->_isAllowedAction('Mymodule_Blog::save')) {
        ...
        if ($this->_isAllowedAction('Mymodule_Blog::post_delete')) {
